...
class CommentController extends GetxController {
  ...
  Future<void> fetchComments(String postId) async {
    ...
    try {
      ...
      comments.value = commentsSnapshot.docs.map((doc) => CommentModel.fromSnapshot(doc)).toList();
    } catch (e) {
  ...
  Future<bool> addComment(String postId, String text) async {
    try {
      ...
      await PostController.to.fetchUserPosts(AuthController.to.userModel.value!.id);
